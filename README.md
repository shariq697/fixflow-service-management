...
- MySQL or PostgreSQL
- Python if app.py is used
- HTML if included in the project

🧱 Database Design Highlights

- Tables normalized using 1NF, 2NF, and 3NF principles
- Well-defined primary and foreign key relationships
- Structured schema supporting efficient querying and reporting

🎯 Project Purpose

This project simulates a real-world service request tracking system. It demonstrates strong understanding of:
...
- Run sample_data.sql if included
- Execute queries.sql to test database operations
- Run app.py if application layer is included

🚀 Future Improvements

- Add a user-friendly interface for easier interaction
- Implement role-based access control admin and user
- Integrate backend API for web deployment
- Add analytics dashboard for service insights

⭐ About This Project

FixFlow is a learning-focused project designed to simulate a production-level database system with real-world structure, relationships, and functionality.
